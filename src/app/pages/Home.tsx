    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        ...
        <div className="relative mb-8">
          ...
          >
            <div className="relative box-border flex h-full w-full min-h-0 min-w-0 flex-col overflow-hidden rounded-full bg-[#000000] p-[1.5%] shadow-[inset_0_0_32px_rgba(0,0,0,0.88),inset_0_1px_2px_rgba(255,255,255,0.04)]">
