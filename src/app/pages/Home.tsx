            ...
            <div className="relative z-10 w-40 h-40 rounded-full overflow-hidden bg-black">
              <img
                ...
                className={`w-full h-full object-contain p-3 transition-all duration-300 ${
                  centerButtonActive
                    ? 'saturate-120 contrast-120 brightness-110 drop-shadow-[0_0_24px_rgba(56,189,248,0.75)]'
                    : 'saturate-110 contrast-110 brightness-105 drop-shadow-[0_0_12px_rgba(148,163,184,0.3)]'
                }`}
              />
            </div>
