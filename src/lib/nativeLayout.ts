...
/** WebView top padding handles status bar on native */
export const LAYOUT_HEADER_PT_CLASS =
  native ? 'pt-2' : 'pt-[max(0.5rem,env(safe-area-inset-top,24px))]';

/** WebView bottom padding handles nav bar on native */
export const LAYOUT_NAV_PB_CLASS = native ? 'pb-2' : 'pb-[max(0.75rem,calc(0.5rem+env(safe-area-inset-bottom,24px)))]';
...
export const LOGIN_FOOTER_PB_CLASS =
  native ? 'pb-4' : 'pb-[max(0.75rem,calc(0.5rem+env(safe-area-inset-bottom,24px)))]';

export const SIGNUP_FOOTER_PB_CLASS =
  native ? 'pb-4' : 'pb-[max(0.75rem,calc(0.5rem+env(safe-area-inset-bottom,0px)))]';
